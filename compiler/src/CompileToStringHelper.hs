...
module CompileToStringHelper where
...
deriving instance Show AST.Canonical.Annotation
...
--   show = T.unpack . T.decodeUtf8 . BSL.toStrict . B.toLazyByteString . Elm.Float.toBuilder
    show _ = "<Float>"
instance Show Elm.Licenses.License where show _ = "\"<Elm.Licenses.License>\""
...
deriving instance Show Reporting.Error.Canonicalize.Error
deriving instance Show Reporting.Error.Canonicalize.BadArityContext
deriving instance Show Reporting.Error.Canonicalize.DuplicatePatternContext
deriving instance Show Reporting.Error.Canonicalize.InvalidPayload
deriving instance Show Reporting.Error.Canonicalize.PortProblem
deriving instance Show Reporting.Error.Canonicalize.PossibleNames
deriving instance Show Reporting.Error.Canonicalize.VarKind
